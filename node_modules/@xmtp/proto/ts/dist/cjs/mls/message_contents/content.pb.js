...
exports.PlaintextEnvelope_V2 = exports.PlaintextEnvelope_V1 = exports.PlaintextEnvelope = exports.EncodedContent_ParametersEntry = exports.EncodedContent = exports.ContentTypeId = exports.compressionToJSON = exports.compressionFromJSON = exports.Compression = exports.protobufPackage = void 0;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const content_pb_1 = require("../../device_sync/content.pb");
const out_of_band_pb_1 = require("./out_of_band.pb");
...
exports.PlaintextEnvelope_V2 = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.deviceSyncRequest !== undefined) {
            content_pb_1.DeviceSyncRequest.encode(message.deviceSyncRequest, writer.uint32(26).fork()).ldelim();
        }
        if (message.deviceSyncReply !== undefined) {
            content_pb_1.DeviceSyncReply.encode(message.deviceSyncReply, writer.uint32(34).fork()).ldelim();
        }
        if (message.userPreferenceUpdate !== undefined) {
            content_pb_1.V1UserPreferenceUpdate.encode(message.userPreferenceUpdate, writer.uint32(42).fork()).ldelim();
        }
        if (message.readdRequest !== undefined) {
            out_of_band_pb_1.ReaddRequest.encode(message.readdRequest, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.deviceSyncRequest = content_pb_1.DeviceSyncRequest.decode(reader, reader.uint32());
                    break;
                case 4:
                    message.deviceSyncReply = content_pb_1.DeviceSyncReply.decode(reader, reader.uint32());
                    break;
                case 5:
                    message.userPreferenceUpdate = content_pb_1.V1UserPreferenceUpdate.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.readdRequest = out_of_band_pb_1.ReaddRequest.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            ...
            deviceSyncRequest: isSet(object.deviceSyncRequest)
                ? content_pb_1.DeviceSyncRequest.fromJSON(object.deviceSyncRequest)
                : undefined,
            deviceSyncReply: isSet(object.deviceSyncReply)
                ? content_pb_1.DeviceSyncReply.fromJSON(object.deviceSyncReply)
                : undefined,
            userPreferenceUpdate: isSet(object.userPreferenceUpdate)
                ? content_pb_1.V1UserPreferenceUpdate.fromJSON(object.userPreferenceUpdate)
                : undefined,
            readdRequest: isSet(object.readdRequest)
                ? out_of_band_pb_1.ReaddRequest.fromJSON(object.readdRequest)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.deviceSyncRequest !== undefined &&
            (obj.deviceSyncRequest = message.deviceSyncRequest
                ? content_pb_1.DeviceSyncRequest.toJSON(message.deviceSyncRequest)
                : undefined);
        message.deviceSyncReply !== undefined &&
            (obj.deviceSyncReply = message.deviceSyncReply
                ? content_pb_1.DeviceSyncReply.toJSON(message.deviceSyncReply)
                : undefined);
        message.userPreferenceUpdate !== undefined &&
            (obj.userPreferenceUpdate = message.userPreferenceUpdate
                ? content_pb_1.V1UserPreferenceUpdate.toJSON(message.userPreferenceUpdate)
                : undefined);
        message.readdRequest !== undefined &&
            (obj.readdRequest = message.readdRequest
                ? out_of_band_pb_1.ReaddRequest.toJSON(message.readdRequest)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.deviceSyncRequest =
            object.deviceSyncRequest !== undefined &&
                ...
                ? content_pb_1.DeviceSyncRequest.fromPartial(object.deviceSyncRequest)
                : undefined;
        message.deviceSyncReply =
            object.deviceSyncReply !== undefined && object.deviceSyncReply !== null
                ? content_pb_1.DeviceSyncReply.fromPartial(object.deviceSyncReply)
                : undefined;
        message.userPreferenceUpdate =
            object.userPreferenceUpdate !== undefined &&
                object.userPreferenceUpdate !== null
                ? content_pb_1.V1UserPreferenceUpdate.fromPartial(object.userPreferenceUpdate)
                : undefined;
        message.readdRequest =
            object.readdRequest !== undefined && object.readdRequest !== null
                ? out_of_band_pb_1.ReaddRequest.fromPartial(object.readdRequest)
                : undefined;
        return message;
    },
};
