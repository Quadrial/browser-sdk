...
export const GroupMutableMetadataV1 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.commitLogSigner !== undefined) {
            writer.uint32(34).bytes(message.commitLogSigner);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    message.commitLogSigner = reader.bytes();
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            ...
            superAdminList: isSet(object.superAdminList)
                ...
                : undefined,
            commitLogSigner: isSet(object.commitLogSigner)
                ? bytesFromBase64(object.commitLogSigner)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.superAdminList !== undefined &&
            (obj.superAdminList = message.superAdminList
                ...
                : undefined);
        message.commitLogSigner !== undefined &&
            (obj.commitLogSigner =
                message.commitLogSigner !== undefined
                    ? base64FromBytes(message.commitLogSigner)
                    : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.superAdminList =
            object.superAdminList !== undefined && object.superAdminList !== null
                ...
                : undefined;
        message.commitLogSigner = (_b = object.commitLogSigner) !== null && _b !== void 0 ? _b : undefined;
        return message;
    },
};
