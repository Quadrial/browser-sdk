...
import { ReaddRequest } from "./out_of_band.pb";
...
export const PlaintextEnvelope_V2 = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.deviceSyncRequest !== undefined) {
            DeviceSyncRequest.encode(message.deviceSyncRequest, writer.uint32(26).fork()).ldelim();
        }
        if (message.deviceSyncReply !== undefined) {
            DeviceSyncReply.encode(message.deviceSyncReply, writer.uint32(34).fork()).ldelim();
        }
        if (message.userPreferenceUpdate !== undefined) {
            V1UserPreferenceUpdate.encode(message.userPreferenceUpdate, writer.uint32(42).fork()).ldelim();
        }
        if (message.readdRequest !== undefined) {
            ReaddRequest.encode(message.readdRequest, writer.uint32(50).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.userPreferenceUpdate = V1UserPreferenceUpdate.decode(reader, reader.uint32());
                    break;
                case 6:
    ...
    fromJSON(object) {
        return {
            ...
            deviceSyncRequest: isSet(object.deviceSyncRequest)
                ? DeviceSyncRequest.fromJSON(object.deviceSyncRequest)
                : undefined,
            deviceSyncReply: isSet(object.deviceSyncReply)
                ? DeviceSyncReply.fromJSON(object.deviceSyncReply)
                : undefined,
            userPreferenceUpdate: isSet(object.userPreferenceUpdate)
                ? V1UserPreferenceUpdate.fromJSON(object.userPreferenceUpdate)
                : undefined,
