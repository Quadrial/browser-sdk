...
export interface PlaintextEnvelope_V2 {
    ...
    readdRequest: ReaddRequest | undefined;
}
    ...
    fromPartial<I extends {
        ...
        v2?: {
            ...
            readdRequest?: {
                ...
                commitLogEpoch?: string | number | Long | undefined;
            } | undefined;
        } | undefined;
    } & {
        v1?: ({
        ...
        v2?: ({
            ...
            readdRequest?: ({
                ...
                groupId?: Uint8Array | undefined;
                commitLogEpoch?: string | number | (Long & {
                    high: number;
                    low: number;
                    unsigned: boolean;
                    add: (addend: string | number | Long) => Long;
                    ...
                    toUnsigned: () => Long;
                    xor: (other: string | number | Long) => Long;
                } & { [K_16 in Exclude<keyof I["v2"]["readdRequest"]["commitLogEpoch"], keyof Long>]: never; }) | undefined;
            } & { [K_17 in Exclude<keyof I["v2"]["readdRequest"], keyof ReaddRequest>]: never; }) | undefined;
        } & { [K_18 in Exclude<keyof I["v2"], keyof PlaintextEnvelope_V2>]: never; }) | undefined;
    } & { [K_19 in Exclude<keyof I, keyof PlaintextEnvelope>]: never; }>(object: I): PlaintextEnvelope;
};
    ...
    fromPartial<I extends {
        ...
        readdRequest?: ({
            ...
            commitLogEpoch?: string | number | (Long & {
                ...
                toUnsigned: () => Long;
                xor: (other: string | number | Long) => Long;
            } & { [K_15 in Exclude<keyof I["readdRequest"]["commitLogEpoch"], keyof Long>]: never; }) | undefined;
        } & { [K_16 in Exclude<keyof I["readdRequest"], keyof ReaddRequest>]: never; }) | undefined;
    } & { [K_17 in Exclude<keyof I, keyof PlaintextEnvelope_V2>]: never; }>(object: I): PlaintextEnvelope_V2;
};
